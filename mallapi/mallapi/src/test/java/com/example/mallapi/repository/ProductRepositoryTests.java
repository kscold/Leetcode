...
public class ProductRepositoryTests {
    ...
    @Transactional // 데이터베이스 연결이 2번 이루어져야하기 때문에 이 어노테이션이 필요함
    @Test
    public void testRead() { // 데이터베이스 연결이 2번이루어지는지 확인하는 메서드
        Long pno = 1L;
    ...
    @Test
    public void testRead2() { // 데이터베이스 연결이 2번이루어지는지 확인하는 메서드
        Long pno = 1L;
